...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("˹IGNORE_SHEIKH˼,", url="t.me/IGNORE_SHEIKH")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("⌯ sυᴘᴘσʀᴛ ⌯", url="https://t.me/FalakAbout"),
            InlineKeyboardButton("⌯ υᴘᴅᴧᴛєs ⌯", url="https://t.me/falakUpdate"),
        ],
        [
